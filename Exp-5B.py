...
# Evaluate UCI Model
accuracy_uci = accuracy_score(
    y_test_uci,
    y_pred_uci
)

precision_uci = precision_score(
    y_test_uci,
    y_pred_uci
)

recall_uci = recall_score(
    y_test_uci,
    y_pred_uci
)
...
# Evaluate Pima Model
accuracy_pima = accuracy_score(
    y_test_pima,
    y_pred_pima
)

precision_pima = precision_score(
    y_test_pima,
    y_pred_pima
)

recall_pima = recall_score(
    y_test_pima,
    y_pred_pima
)
...
print(
    f"Accuracy: {accuracy_uci:.4f}, "
    f"Precision: {precision_uci:.4f}, "
    f"Recall: {recall_uci:.4f}, "
    f"F1 Score: {f1_uci:.4f}"
)
...
print(
    f"Accuracy: {accuracy_pima:.4f}, "
    f"Precision: {precision_pima:.4f}, "
    f"Recall: {recall_pima:.4f}, "
    f"F1 Score: {f1_pima:.4f}"
)
...
axes[1].set_title(
    "Pima Indians Diabetes - Confusion Matrix"
)
